const ApiKey = "25130b8e02f44d9f9d5ee8df8950fffb";
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="http://127.0.0.1:5501/index.html#modal1" class="secondary-content waves-effect waves-light btn modal-trigger" href="#!"><i class="material-icons">info</i></a>
                </li>`
            });
...
function showTeamInfo(id) {
    contents.innerHTML = 'detail informasi team'
}
